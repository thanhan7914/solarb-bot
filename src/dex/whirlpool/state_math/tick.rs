use super::{
    CoreError, FULL_RANGE_ONLY_TICK_SPACING_THRESHOLD, MAX_TICK_INDEX, MIN_TICK_INDEX,
    types::tick_array::TICK_ARRAY_SIZE, TICK_INDEX_NOT_IN_ARRAY, state::tick::TickRange, types::u128::U128,
};
use ethnum::U256;
...
fn mul_shift_96(n0: u128, n1: u128) -> u128 {
    ...
    mul.try_into().expect("Error cast u128")
}
